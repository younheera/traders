...
import com.newus.traders.model.repository.KakaoUserRepository;

@Service
public class KakaoUserService {

    @Autowired
    KakaoUserRepository userRepository; //(1)
     ...
     public OauthToken getAccessToken(String code) {
        ...
        params.add("client_id", "8c571d1d5c463099c5a36483a636919e");
        params.add("redirect_uri", "http://localhost:3000/redirect");
        params.add("code", code);
        params.add("client_secret", "4Xk507fkLFlWSCswYLPxyNnihC9IqdoT");
    ...
    public KakaoUser saveUser(String token){
        ...
        KakaoUser user = userRepository.findByKakaoEmail(profile.getKakao_account().getEmail());
