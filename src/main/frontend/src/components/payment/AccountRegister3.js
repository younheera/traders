 ...
 * @modify date 2023-10-22 21:35:34
 */
...
const AccountRegister3 = ({postAccountInfo}) => {
    ...
    return (
        ...
        <Container style={{maxWidth: "1040px",height:'350px'}} className='account-container-2' >
            ...
            <Row  style={{marginTop:'20px'}} className='account-3-row-3'>
                <Col md={6}>
