 ...
 * @modify date 2023-09-27 14:36:14
 * @desc [description]
 */
/* eslint-disable */ 
...
const Chat1 = () => {
  ...
  const msgInputRef = useRef(null);
   ...
   useEffect(() => {
     ...
     setUsername('11');
     setRoomNum(10);
     axios.get(`http://localhost:8080/api/chat/roomNum/10`)
       .then((res) => {
         console.log(res);
        ...
        <div >
          <div >
            <div >
              ...
              <span id="username">{/* 여기에 username을 출력하려면 username 변수를 사용하세요 */}</span>
            </div>
            <div>
            ...
            <div >
              <div>
                ...
                <button type="button" onClick={sendMessage}>
                  <i className="fa fa-paper-plane" aria-hidden="true" />보내기
                </button>
              </div>
            </div>
          </div>
