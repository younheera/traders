...
// ProductForm form1 = new ProductForm("product1", 1L, "product no.1",
// "clothes", 37.49, 127.03);
// ProductForm form2 = new ProductForm("product2", 2L, "product no.2", "shoes",
// 37.8, 127.06);
...
// when(productRepository.findByDistance(37.49, 127.03,
// 3)).thenReturn(Arrays.asList(product1));

// List<ProductDto> productDtoList = productService.getNearestProducts(37.49,
// 127.03);
